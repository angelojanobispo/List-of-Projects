...
<body>
    ...
    <style>
        ...
        .time-in-button {
            border: 3px solid #FFC107;  /* Change to the desired color */
        }
        .submitbutton {
            align-items: center;
        }
    ...
    <div class="container">
        <div class="container-form">
            ...
            <div class="form-group">
                <a href="timein.php" class="link-button time-in-button">Time In</a>
                <a href="timeout.php" class="link-button">Time Out</a>
            </div>
            <br>
            <form action="timein_process.php" method="post">
                <div class="form-group">
